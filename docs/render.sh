...
$GUIDES/run.sh 01_explore_graph_answers.adoc 01_explore_graph_answers.html +1 $BASE_URL
...
$GUIDES/run.sh 03_inferred_answers.adoc 03_inferred_answers.html +1 $BASE_URL
$GUIDES/run.sh 04_events.adoc 04_events.html +1 $BASE_URL
$GUIDES/run.sh 05_venues.adoc 05_venues.html +1 $BASE_URL
$GUIDES/run.sh 05_venues_import_answers.adoc 05_venues_import_answers.html +1 $BASE_URL
...
$GUIDES/run.sh 06_my_venues_answers.adoc 06_my_venues_answers.html +1 $BASE_URL
$GUIDES/run.sh 07_procedures.adoc 07_procedures.html +1 $BASE_URL
$GUIDES/run.sh 07_photos_answers.adoc 07_photos_answers.html +1 $BASE_URL
