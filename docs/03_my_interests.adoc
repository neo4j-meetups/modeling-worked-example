...
image::{img}/slides.jpg[]
pass:a[<a play-topic='{guides}/03_inferred_answers.html'>Answers: Inferring interests</a>]

pass:a[<a play-topic='{guides}/03_inferred_answers.html'>Answers: Inferred Interests</a>]
