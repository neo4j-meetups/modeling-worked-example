...
If you haven't then grab a USB stick from one of the trainers or download the latest version of apoc from link:https://github.com/jexp/neo4j-apoc-procedures/releases/latest[]
